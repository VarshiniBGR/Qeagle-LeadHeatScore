...
class EmailService:
    """Service for sending emails via SMTP with async support."""
    ...
    async def send_email(
        ...
        """
        Send an email to the specified recipient asynchronously.
        ...
        try:
            ...
            await asyncio.to_thread(self._send_email_sync, message, to_email)
    ...
    def _send_email_sync(self, message: MIMEMultipart, to_email: str) -> None:
